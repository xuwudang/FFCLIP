...
if __name__ == '__main__':
    # 测试代码
    block = RCM(dim=768, qk_dim=16, pdim=32)
    input = torch.randn(1, 197, 768)  # 模拟 CLIP 的 image_features，[B, N, D]
    output = block(input)
    print("Input shape:", input.shape)  # [1, 197, 768]
    print("Output shape:", output.shape)  # [1, 197, 768]
